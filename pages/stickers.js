    ...
    return (
        <div>
            <Head>
                ...
                <meta name="description" content="buy stickers " />
                ...
                <section className="text-gray-600 body-font">
                    <div className="container px-5 py-4 mx-auto">
                        <div className="flex flex-wrap mt-1">
                            ...
                            <div className="lg:w-1/4 md:w-1/2 p-4 w-full  shadow-lg">
                                <a className="block relative  max-h-96  rounded overflow-hidden shadow-lg cursor-pointer">
                                    <Image alt="ecommerce" className="object-cover object-center w-full h-full block" src="/pic.jpg" width={355} height={455} />
                                </a>
                                <div className="mt-4">
                                    <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>

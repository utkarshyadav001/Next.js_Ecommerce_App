...
const Mugs = ({ products }) => {
  ...
  return (
    <div>
      <Head>
        <title>Shopwears || Mugs</title>
        <meta name="description" content="Buy amazing mugs" />
      ...
      <main>
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-4 mx-auto">
            ...
            {Object.keys(products).length == 0 && <p className=' block my-4 text-center text-md text-red-500'>Sorry, all the mugs is currently out of stock. New stock coming soon. Stay Tuned!</p>}

      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-8 lg:py-12 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <Image alt="ecommerce" className="rounded  w-full h-1/2 md:h-1/2 md:w-1/2 lg:h-2/5 lg:w-2/5" src="/image/portfolio5.png" width={355} height={455} />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 md:w-1/2 md:pl-5">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">BRAND {slugs} </h2>

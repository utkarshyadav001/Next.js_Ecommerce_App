...
const Hoodies = ({ products }) => {
  ...
  return (
    <div>
      <Head>
        <title>Shopwears || Hoodies</title>
        <meta name="description" content="Buy amazing Hoodies for men, women, kinds" />
      ...
      <main>
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-4 mx-auto">
            ...
            {Object.keys(products).length ==0 && <p className=' block my-4 text-center text-md text-red-500'>Sorry, all the Hoodies is currently out of stock. New stock coming soon. Stay Tuned!</p>}

            <div className="flex flex-wrap mt-1">
              {
                products && Object.keys(products).map((item) => {
                  return <Link href={`product/${products[item].slug}`} key={products[item].slug} className="lg:w-1/4 md:w-1/2 p-4 w-full  shadow-lg" >
